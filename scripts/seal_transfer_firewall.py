"""Seal transfer-firewall challenge and labels in content-addressed S3."""
    ...
    *,
    ...
    objects = {
        "challenge": _seal_object(
            ...
            kind="transfer-firewall-challenge",
        ),
        "labels": _seal_object(
            client,
            bucket=bucket,
            ...
            body=labels_bytes,
            kind="transfer-firewall-sealed-labels",
        ),
        "commitment": _seal_object(
            ...
            kind="transfer-firewall-commitment",
        ),
    }
    receipt: dict[str, Any] = {
        "schema_version": 1,
        "kind": "continuum.transfer-firewall.s3-seal-receipt",
