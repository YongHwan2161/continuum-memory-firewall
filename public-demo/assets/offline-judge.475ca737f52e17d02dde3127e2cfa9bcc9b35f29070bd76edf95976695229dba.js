...
(function () {
  ...
  async function runOffline() {
    ...
    try {
      ...
      const core = capsuleGate && envelopeBound && provenanceBound && transactionBound && providerStoryBound && scriptDeliveryBound;
