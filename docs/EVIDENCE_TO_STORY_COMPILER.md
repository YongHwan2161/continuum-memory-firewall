...
The v18 judge delivery is generated from immutable receipts. It is not an editable
...
The v21 promotion step preserves and binds the unchanged receipt-compiled story to:
...
- immutable `hackathon-v21` envelope, story, CI recovery, adaptive diagnosis,
  transfer-firewall, and online-memory-lineage release assets. The current video
  predates the adaptive, transfer, and online-lineage results and does not
  narrate them; their dedicated pages and the verifier carry that newer
  evidence.
