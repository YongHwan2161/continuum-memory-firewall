...
is `PAGES_MATERIALIZED`, receipt SHA-256 is `454b29f5…26bb6`, and it binds
coordinator artifact `9083135472` with digest `sha256:b1930b3e…67bea9`.
Credential-free monitor run `31442028079` then passed the complete public judge
