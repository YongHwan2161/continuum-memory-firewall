...
class McpHostInfrastructureTests(unittest.TestCase):
    ...
    def test_private_host_package_contains_live_security_gates(self):
        ...
        for path in (
            ...
            "run_kms_authority_lifecycle_proof.py",
            "seed_judge_story.py",
    ...
    def test_release_envelope_binds_guardian_raw_and_public_receipts(self):
        ...
        self.assertIn("default: hackathon-v35", workflow)
        ...
        self.assertIn("--kms-outcome-authority-public", workflow)
        self.assertIn("provider-origin-story-v1.json.sha256", workflow)
